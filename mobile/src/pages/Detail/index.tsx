...
const Detail = () => {
  ...
  function handleWhatsapp() { //${data.point.whatsapp}
    Linking.openURL(`whatsapp://send?phone=${data.point.whatsapp}&text=Tenho interesse no seu ponto de coleta de resíduos. Gostaria de mais informações.`)
  }
